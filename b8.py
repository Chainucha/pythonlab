...
def save_data():
    ...
    data = pd.DataFrame([[batmans,int(y2017),int(y2018),int(y2019),int(y2020)]],columns=["Batmans","2017","2018","2019","2020"])
...
def show_graph():
    try:
        ...
        messagebox.showwarning("File Error", "No data file found. Please save some data first.")
        return
...
Label(window,text="Enter Batmans Performance data:",font=("Arial",14,"bold")).pack(pady=10)
